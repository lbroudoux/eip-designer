 ...
 * 
 */
public class RecipientListRouterPropertiesEditionComponent extends SiriusAwarePropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EipViewsRepository.RecipientListRouter.Properties.toChannel)) {
				// init part
				toChannelSettings = new EObjectFlatComboSettings(recipientListRouter, EipPackage.eINSTANCE.getEndpoint_ToChannel());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == EipViewsRepository.RecipientListRouter.Properties.toChannel) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EipViewsRepository.RecipientListRouter.Properties.toChannel == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EipPackage.eINSTANCE.getEndpoint_ToChannel().equals(msg.getFeature()) && basePart != null && isAccessible(EipViewsRepository.RecipientListRouter.Properties.toChannel))
