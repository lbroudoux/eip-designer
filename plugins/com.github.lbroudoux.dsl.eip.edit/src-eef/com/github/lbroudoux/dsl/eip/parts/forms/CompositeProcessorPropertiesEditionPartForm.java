 ...
 * 
 */
public class CompositeProcessorPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CompositeProcessorPropertiesEditionPart {
	 ...
	 */
	public CompositeProcessorPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public CompositeProcessorPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(EipViewsRepository.CompositeProcessor.Properties.toChannel);
		...
		composer = new PartComposer(compositeProcessorStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EipViewsRepository.CompositeProcessor.Properties.toChannel) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeProcessorPropertiesEditionPartForm.this,
							EipViewsRepository.CompositeProcessor.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, EipViewsRepository.CompositeProcessor.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.CompositeProcessor.Properties.name, EipViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createToChannelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, EipViewsRepository.CompositeProcessor.Properties.toChannel, EipMessages.CompositeProcessorPropertiesEditionPart_ToChannelLabel);
		toChannel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EipViewsRepository.CompositeProcessor.Properties.toChannel, EipViewsRepository.FORM_KIND));
		...
		toChannel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.toChannel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getToChannel()));
			}

		});
		toChannel.setID(EipViewsRepository.CompositeProcessor.Properties.toChannel);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.CompositeProcessor.Properties.toChannel, EipViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFromChannelsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.fromChannels = new ReferencesTable(getDescription(EipViewsRepository.CompositeProcessor.Properties.fromChannels, EipMessages.CompositeProcessorPropertiesEditionPart_FromChannelsLabel), new ReferencesTableListener	() {
		...
		this.fromChannels.setHelpText(propertiesEditionComponent.getHelpContent(EipViewsRepository.CompositeProcessor.Properties.fromChannels, EipViewsRepository.FORM_KIND));
		...
		this.fromChannels.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.fromChannels, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"fromChannels", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.fromChannels,
	...
	protected void moveFromChannels(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		fromChannels.refresh();
	}
	...
	protected void removeFromFromChannels(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CompositeProcessorPropertiesEditionPartForm.this, EipViewsRepository.CompositeProcessor.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		fromChannels.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#getToChannel()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#initToChannel(EObjectFlatComboSettings)
	 */
	public void initToChannel(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EipViewsRepository.CompositeProcessor.Properties.toChannel);
		if (eefElementEditorReadOnlyState && toChannel.isEnabled()) {
			toChannel.setEnabled(false);
			toChannel.setToolTipText(EipMessages.CompositeProcessor_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#setToChannel(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#setToChannelButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#addFilterToChannel(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.CompositeProcessorPropertiesEditionPart#addBusinessFilterToChannel(ViewerFilter filter)
	 * 
	 */
