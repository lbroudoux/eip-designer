...
public class ContentFilterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ContentFilterPropertiesEditionPart {
	...
	protected Composite createToChannelFlatComboViewer(Composite parent) {
		...
		toChannel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EipViewsRepository.ContentFilter.Properties.toChannel, EipViewsRepository.SWT_KIND));
		...
		toChannel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ContentFilterPropertiesEditionPartImpl.this, EipViewsRepository.ContentFilter.Properties.toChannel, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getToChannel()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.ContentFilter.Properties.toChannel, EipViewsRepository.SWT_KIND), null); //$NON-NLS-1$
