 ...
 * 
 */
public class InvocableEndpointPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EipViewsRepository.InvocableEndpoint.Properties.toChannels)) {
				toChannelsSettings = new ReferencesTableSettings(invocableEndpoint, EipPackage.eINSTANCE.getEndpoint_ToChannels());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == EipViewsRepository.InvocableEndpoint.Properties.toChannels) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EipViewsRepository.InvocableEndpoint.Properties.toChannels == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EipPackage.eINSTANCE.getEndpoint_ToChannels().equals(msg.getFeature())  && isAccessible(EipViewsRepository.InvocableEndpoint.Properties.toChannels))
