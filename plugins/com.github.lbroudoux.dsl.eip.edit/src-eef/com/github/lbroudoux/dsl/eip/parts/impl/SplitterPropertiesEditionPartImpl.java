 ...
 * 
 */
public class SplitterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SplitterPropertiesEditionPart {
	 ...
	 * 
	 */
	public SplitterPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		...
		propertiesStep.addStep(EipViewsRepository.Splitter.Properties.toChannel);
		...
		composer = new PartComposer(splitterStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EipViewsRepository.Splitter.Properties.toChannel) {
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SplitterPropertiesEditionPartImpl.this, EipViewsRepository.Splitter.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.Splitter.Properties.name, EipViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createToChannelFlatComboViewer(Composite parent) {
		createDescription(parent, EipViewsRepository.Splitter.Properties.toChannel, EipMessages.SplitterPropertiesEditionPart_ToChannelLabel);
		toChannel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EipViewsRepository.Splitter.Properties.toChannel, EipViewsRepository.SWT_KIND));
		...
		toChannel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SplitterPropertiesEditionPartImpl.this, EipViewsRepository.Splitter.Properties.toChannel, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getToChannel()));
			}

		});
		GridData toChannelData = new GridData(GridData.FILL_HORIZONTAL);
		toChannel.setLayoutData(toChannelData);
		toChannel.setID(EipViewsRepository.Splitter.Properties.toChannel);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.Splitter.Properties.toChannel, EipViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createFromChannelsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(EipViewsRepository.Splitter.Properties.fromChannels, EipMessages.SplitterPropertiesEditionPart_FromChannelsLabel);		 
		...
		this.fromChannels.setHelpText(propertiesEditionComponent.getHelpContent(EipViewsRepository.Splitter.Properties.fromChannels, EipViewsRepository.SWT_KIND));
		this.fromChannels.createControls(parent);
		this.fromChannels.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SplitterPropertiesEditionPartImpl.this, EipViewsRepository.Splitter.Properties.fromChannels, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void moveFromChannels(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SplitterPropertiesEditionPartImpl.this, EipViewsRepository.Splitter.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		fromChannels.refresh();
	}
	...
	protected void removeFromFromChannels(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SplitterPropertiesEditionPartImpl.this, EipViewsRepository.Splitter.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		fromChannels.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#getToChannel()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#initToChannel(EObjectFlatComboSettings)
	 */
	public void initToChannel(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EipViewsRepository.Splitter.Properties.toChannel);
		if (eefElementEditorReadOnlyState && toChannel.isEnabled()) {
			toChannel.setEnabled(false);
			toChannel.setToolTipText(EipMessages.Splitter_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#setToChannel(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#setToChannelButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#addFilterToChannel(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.SplitterPropertiesEditionPart#addBusinessFilterToChannel(ViewerFilter filter)
	 * 
	 */
