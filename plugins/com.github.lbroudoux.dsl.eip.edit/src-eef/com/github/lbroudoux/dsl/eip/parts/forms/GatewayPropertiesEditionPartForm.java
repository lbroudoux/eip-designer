...
public class GatewayPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, GatewayPropertiesEditionPart {
	...
	protected Composite createToChannelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		toChannel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EipViewsRepository.Gateway.Properties.toChannel, EipViewsRepository.FORM_KIND));
		...
		toChannel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GatewayPropertiesEditionPartForm.this, EipViewsRepository.Gateway.Properties.toChannel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getToChannel()));
			}

		});
		toChannel.setID(EipViewsRepository.Gateway.Properties.toChannel);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.Gateway.Properties.toChannel, EipViewsRepository.FORM_KIND), null); //$NON-NLS-1$
