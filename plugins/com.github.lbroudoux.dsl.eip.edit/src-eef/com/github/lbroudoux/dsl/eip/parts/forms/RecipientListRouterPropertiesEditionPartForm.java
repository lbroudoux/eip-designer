 ...
 * 
 */
public class RecipientListRouterPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RecipientListRouterPropertiesEditionPart {
	 ...
	 */
	public RecipientListRouterPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public RecipientListRouterPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(EipViewsRepository.RecipientListRouter.Properties.toChannels);
		...
		composer = new PartComposer(recipientListRouterStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EipViewsRepository.RecipientListRouter.Properties.toChannels) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RecipientListRouterPropertiesEditionPartForm.this,
							EipViewsRepository.RecipientListRouter.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, EipViewsRepository.RecipientListRouter.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EipViewsRepository.RecipientListRouter.Properties.name, EipViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createToChannelsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.toChannels = new ReferencesTable(getDescription(EipViewsRepository.RecipientListRouter.Properties.toChannels, EipMessages.RecipientListRouterPropertiesEditionPart_ToChannelsLabel), new ReferencesTableListener	() {
		...
		this.toChannels.setHelpText(propertiesEditionComponent.getHelpContent(EipViewsRepository.RecipientListRouter.Properties.toChannels, EipViewsRepository.FORM_KIND));
		...
		this.toChannels.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.toChannels, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		toChannels.setID(EipViewsRepository.RecipientListRouter.Properties.toChannels);
		...
		"toChannels", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.toChannels,
	...
	protected void moveToChannels(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.toChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		toChannels.refresh();
	}
	...
	protected void removeFromToChannels(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.toChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		toChannels.refresh();
	}
	...
	protected Composite createFromChannelsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.fromChannels = new ReferencesTable(getDescription(EipViewsRepository.RecipientListRouter.Properties.fromChannels, EipMessages.RecipientListRouterPropertiesEditionPart_FromChannelsLabel), new ReferencesTableListener	() {
		...
		this.fromChannels.setHelpText(propertiesEditionComponent.getHelpContent(EipViewsRepository.RecipientListRouter.Properties.fromChannels, EipViewsRepository.FORM_KIND));
		this.fromChannels.createControls(parent, widgetFactory);
		this.fromChannels.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.fromChannels, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addFromChannels() {
		...
		"fromChannels", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.fromChannels,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveFromChannels(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		fromChannels.refresh();
	}
	...
	protected void removeFromFromChannels(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.fromChannels, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		fromChannels.refresh();
	}
	...
	protected Composite createOwnedRoutesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedRoutes = new ReferencesTable(getDescription(EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, EipMessages.RecipientListRouterPropertiesEditionPart_OwnedRoutesLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedRoutes.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedRoutes.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedRoutes.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedRoutes.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedRoutes.setHelpText(propertiesEditionComponent.getHelpContent(EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, EipViewsRepository.FORM_KIND));
		this.ownedRoutes.createControls(parent, widgetFactory);
		this.ownedRoutes.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RecipientListRouterPropertiesEditionPartForm.this, EipViewsRepository.RecipientListRouter.Properties.ownedRoutes, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.RecipientListRouterPropertiesEditionPart#initToChannels(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initToChannels(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EipViewsRepository.RecipientListRouter.Properties.toChannels);
		if (eefElementEditorReadOnlyState && toChannels.getTable().isEnabled()) {
			toChannels.setEnabled(false);
			toChannels.setToolTipText(EipMessages.RecipientListRouter_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.RecipientListRouterPropertiesEditionPart#updateToChannels()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.RecipientListRouterPropertiesEditionPart#addFilterToChannels(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.RecipientListRouterPropertiesEditionPart#addBusinessFilterToChannels(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see com.github.lbroudoux.dsl.eip.parts.RecipientListRouterPropertiesEditionPart#isContainedInToChannelsTable(EObject element)
	 * 
	 */
