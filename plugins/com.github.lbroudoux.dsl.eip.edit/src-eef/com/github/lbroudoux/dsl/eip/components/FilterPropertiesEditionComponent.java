 ...
 * 
 */
public class FilterPropertiesEditionComponent extends SiriusAwarePropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EipViewsRepository.Filter.Properties.toChannel)) {
				// init part
				toChannelSettings = new EObjectFlatComboSettings(filter, EipPackage.eINSTANCE.getEndpoint_ToChannel());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == EipViewsRepository.Filter.Properties.toChannel) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (EipViewsRepository.Filter.Properties.toChannel == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (EipPackage.eINSTANCE.getEndpoint_ToChannel().equals(msg.getFeature()) && basePart != null && isAccessible(EipViewsRepository.Filter.Properties.toChannel))
