 ...
 * <ul>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.EnricherImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.EnricherImpl#getToChannel <em>To Channel</em>}</li>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.EnricherImpl#getFromChannel <em>From Channel</em>}</li>
 ...
 * @generated
 */
public class EnricherImpl extends MinimalEObjectImpl.Container implements Enricher {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.ENRICHER__NAME, oldName, name));
	}
	...
	public Channel getToChannel() {
		if (toChannel != null && toChannel.eIsProxy()) {
			...
			if (toChannel != oldToChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.ENRICHER__TO_CHANNEL, oldToChannel, toChannel));
			}
		}
		return toChannel;
	}
	...
	public NotificationChain basicSetToChannel(Channel newToChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.ENRICHER__TO_CHANNEL, oldToChannel, newToChannel);
	...
	public void setToChannel(Channel newToChannel) {
		if (newToChannel != toChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.ENRICHER__TO_CHANNEL, newToChannel, newToChannel));
	}
	...
	public Channel getFromChannel() {
		if (fromChannel != null && fromChannel.eIsProxy()) {
			...
			if (fromChannel != oldFromChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.ENRICHER__FROM_CHANNEL, oldFromChannel, fromChannel));
			}
		}
		return fromChannel;
	}
	...
	public NotificationChain basicSetFromChannel(Channel newFromChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.ENRICHER__FROM_CHANNEL, oldFromChannel, newFromChannel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFromChannel(Channel newFromChannel) {
		if (newFromChannel != fromChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.ENRICHER__FROM_CHANNEL, newFromChannel, newFromChannel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EipPackage.ENRICHER__TO_CHANNEL:
				if (toChannel != null)
					msgs = ((InternalEObject)toChannel).eInverseRemove(this, EipPackage.CHANNEL__FROM_ENDPOINT, Channel.class, msgs);
				return basicSetToChannel((Channel)otherEnd, msgs);
			case EipPackage.ENRICHER__FROM_CHANNEL:
				if (fromChannel != null)
					msgs = ((InternalEObject)fromChannel).eInverseRemove(this, EipPackage.CHANNEL__TO_ENDPOINT, Channel.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EipPackage.ENRICHER__NAME:
				return getName();
			case EipPackage.ENRICHER__TO_CHANNEL:
