 ...
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.GatewayImpl#getFromChannel <em>From Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GatewayImpl extends MinimalEObjectImpl.Container implements Gateway {
	...
	public Channel getFromChannel() {
		if (fromChannel != null && fromChannel.eIsProxy()) {
			...
			if (fromChannel != oldFromChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.GATEWAY__FROM_CHANNEL, oldFromChannel, fromChannel));
			}
		}
		return fromChannel;
	}
	...
	public NotificationChain basicSetFromChannel(Channel newFromChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.GATEWAY__FROM_CHANNEL, oldFromChannel, newFromChannel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFromChannel(Channel newFromChannel) {
		if (newFromChannel != fromChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.GATEWAY__FROM_CHANNEL, newFromChannel, newFromChannel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EipPackage.GATEWAY__FROM_CHANNEL:
				if (fromChannel != null)
					msgs = ((InternalEObject)fromChannel).eInverseRemove(this, EipPackage.CHANNEL__TO_ENDPOINT, Channel.class, msgs);
