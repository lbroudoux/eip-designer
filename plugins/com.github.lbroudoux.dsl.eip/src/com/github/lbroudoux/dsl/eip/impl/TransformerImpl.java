 ...
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.TransformerImpl#getFromChannel <em>From Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TransformerImpl extends MinimalEObjectImpl.Container implements Transformer {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.TRANSFORMER__NAME, oldName, name));
	}
	...
	public Channel getToChannel() {
		if (toChannel != null && toChannel.eIsProxy()) {
			...
			if (toChannel != oldToChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.TRANSFORMER__TO_CHANNEL, oldToChannel, toChannel));
			}
		}
		return toChannel;
	}
	...
	public NotificationChain basicSetToChannel(Channel newToChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.TRANSFORMER__TO_CHANNEL, oldToChannel, newToChannel);
	...
	public void setToChannel(Channel newToChannel) {
		if (newToChannel != toChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.TRANSFORMER__TO_CHANNEL, newToChannel, newToChannel));
	}
	...
	public Channel getFromChannel() {
		if (fromChannel != null && fromChannel.eIsProxy()) {
			...
			if (fromChannel != oldFromChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.TRANSFORMER__FROM_CHANNEL, oldFromChannel, fromChannel));
			}
		}
		return fromChannel;
	}
	...
	public NotificationChain basicSetFromChannel(Channel newFromChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.TRANSFORMER__FROM_CHANNEL, oldFromChannel, newFromChannel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFromChannel(Channel newFromChannel) {
		if (newFromChannel != fromChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.TRANSFORMER__FROM_CHANNEL, newFromChannel, newFromChannel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case EipPackage.TRANSFORMER__FROM_CHANNEL:
				if (fromChannel != null)
					msgs = ((InternalEObject)fromChannel).eInverseRemove(this, EipPackage.CHANNEL__TO_ENDPOINT, Channel.class, msgs);
