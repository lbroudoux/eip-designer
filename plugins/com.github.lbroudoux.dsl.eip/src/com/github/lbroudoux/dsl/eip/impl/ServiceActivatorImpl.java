...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Activator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.ServiceActivatorImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.ServiceActivatorImpl#getToChannel <em>To Channel</em>}</li>
 *   <li>{@link com.github.lbroudoux.dsl.eip.impl.ServiceActivatorImpl#getFromChannel <em>From Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ServiceActivatorImpl extends MinimalEObjectImpl.Container implements ServiceActivator {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.SERVICE_ACTIVATOR__NAME, oldName, name));
	}
	...
	public Channel getToChannel() {
		if (toChannel != null && toChannel.eIsProxy()) {
			...
			if (toChannel != oldToChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.SERVICE_ACTIVATOR__TO_CHANNEL, oldToChannel, toChannel));
			}
		}
		return toChannel;
	}
	...
	public NotificationChain basicSetToChannel(Channel newToChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.SERVICE_ACTIVATOR__TO_CHANNEL, oldToChannel, newToChannel);
	...
	public void setToChannel(Channel newToChannel) {
		if (newToChannel != toChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.SERVICE_ACTIVATOR__TO_CHANNEL, newToChannel, newToChannel));
	}
	...
	public Channel getFromChannel() {
		if (fromChannel != null && fromChannel.eIsProxy()) {
			...
			if (fromChannel != oldFromChannel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EipPackage.SERVICE_ACTIVATOR__FROM_CHANNEL, oldFromChannel, fromChannel));
			}
		}
		return fromChannel;
	}
	...
	public NotificationChain basicSetFromChannel(Channel newFromChannel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EipPackage.SERVICE_ACTIVATOR__FROM_CHANNEL, oldFromChannel, newFromChannel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFromChannel(Channel newFromChannel) {
		if (newFromChannel != fromChannel) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EipPackage.SERVICE_ACTIVATOR__FROM_CHANNEL, newFromChannel, newFromChannel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EipPackage.SERVICE_ACTIVATOR__TO_CHANNEL:
				if (toChannel != null)
					msgs = ((InternalEObject)toChannel).eInverseRemove(this, EipPackage.CHANNEL__FROM_ENDPOINT, Channel.class, msgs);
				return basicSetToChannel((Channel)otherEnd, msgs);
			case EipPackage.SERVICE_ACTIVATOR__FROM_CHANNEL:
				if (fromChannel != null)
					msgs = ((InternalEObject)fromChannel).eInverseRemove(this, EipPackage.CHANNEL__TO_ENDPOINT, Channel.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EipPackage.SERVICE_ACTIVATOR__NAME:
				return getName();
			case EipPackage.SERVICE_ACTIVATOR__TO_CHANNEL:
